...
const SECTIONS = [
  ...
  },
  {
    ...
    color: '#10B981',
    steps: [
      'Creá tu propia liga de amigos, barrio o trabajo.',
      'Tocá "+" en la pestaña Liga para crear una nueva liga y ponerle nombre.',
      'Agregá los equipos con nombre, color y badge personalizado.',
      'El sistema genera el fixture completo automáticamente (todos contra todos).',
      'Cargá los resultados tocando el marcador de cada partido.',
      'La tabla de posiciones (PJ, G, E, P, GF, GC, DG, Pts) se actualiza sola.',
      'Podés tener hasta 1 liga activa en el plan gratuito.',
    ],
  },
  {
    icon: 'robot' as const,
    ...
    color: '#8B5CF6',
    steps: [
      'El Simulador predice cómo terminaría el torneo completo.',
      'Modo IA: la inteligencia artificial simula todos los partidos según estadísticas reales.',
      'Modo Manual: vos elegís quién gana en cada partido de la fase eliminatoria.',
      'Tocá "Simular" y el sistema muestra grupos, octavos, cuartos, semis y la gran final.',
      'Podés compartir tu simulación con amigos.',
    ],
  },
  {
    icon: 'cog' as const,
  ...
  },
  {
    ...
    steps: [
      ...
      '  🤖 Análisis IA (GPT-4) de cada partido antes de que empiece.',
      '  🔮 Simulador con IA completo.',
      '  🏟️ Ligas locales ilimitadas.',
      '  📡 Radar en vivo con posiciones animadas.',
      '  🚫 Sin publicidad.',
